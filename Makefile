...
# onprem.edenlab.io/on-premise-configurator-bundle:$VERSION and onprem.edenlab.io/on-premise-configurator-catalog:$VERSION.
IMAGE_TAG_BASE ?= onprem.edenlab.io/on-premise-configurator
